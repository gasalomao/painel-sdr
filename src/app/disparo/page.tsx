  ...
  async function loadAiModels() {
    ...
    try {
      ...
      if (d.success && Array.isArray(d.models)) {
        ...
        setAiModel(prev => prev || d.models[0]?.id || "");
      } else if (d.error) {
                ...
                <div className="flex items-center justify-between p-3 rounded-xl bg-blue-500/10 border border-blue-500/30">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-[12px] text-blue-100">
                      Editando campanha existente. <strong className="text-white">Os clientes/targets não serão alterados.</strong>
                    </p>
                  </div>
                  <Button
                    size="sm"
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="mt-2 p-3 rounded-lg bg-emerald-500/5 border border-emerald-500/15">
                      <p className="text-[9px] uppercase font-black tracking-widest text-emerald-400 mb-1">Pré-visualização (1º cliente selecionado)</p>
                      ...
                      <div className="ml-6 space-y-3 p-4 rounded-xl bg-cyan-500/5 border border-cyan-500/20">
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className="w-full mt-1 bg-white/5 border border-white/10 text-white h-11 rounded-xl text-sm px-3 focus:outline-none focus:ring-1 focus:ring-cyan-500/50 disabled:opacity-50"
                          >
                            <option value="" className="bg-neutral-900 text-muted-foreground">
                              {aiModels.length === 0
                            ...
                            {!isAdmin && defaultAiModel && !aiModels.some(m => m.id === defaultAiModel) && (
                              <option value={defaultAiModel} className="bg-neutral-900 text-white">{defaultAiModel}</option>
                            )}
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="max-h-[480px] overflow-y-auto space-y-1.5 pr-1">
                    ...
                    {filteredLeads.length === 0 && (
                      <p className="text-center text-[11px] text-muted-foreground py-8">Nenhum cliente com esses filtros.</p>
                    )}
                  </div>
                </CardContent>
              </Card>
