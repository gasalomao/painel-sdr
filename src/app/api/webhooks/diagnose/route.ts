 ...
 *
 * SaaS: cliente comum diagnostica a SUA instância. Admin não-impersonando
 * diagnostica qualquer uma (precisa pra suporte).
 */
export async function GET(req: NextRequest) {
  ...
  // Cliente comum (ou admin impersonando) só vê diagnóstico da SUA instância.
  // Admin não-impersonando vê qualquer uma.
  if (!auth.isAdmin) {
