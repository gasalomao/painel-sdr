...
const EDITABLE_FIELDS = [
  ...
  "dispatch_media_url",
  "dispatch_media_type",
  "dispatch_media_caption",
  "dispatch_media_file_name",
  "dispatch_media_mimetype",
...
export async function PATCH(req: NextRequest, ctx: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    // scrape_filters guarda a config do usuário (filterEmpty, filterLandlines…)
    // MAS o worker também grava ali marcadores de runtime (_baselineMaxId,
    // _scrapeStartedAt, _lastProgressAt, _baselineCount). O formulário só manda
    // a config — sobrescrever direto APAGA os marcadores, e aí o disparo não
