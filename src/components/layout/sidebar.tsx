...
const navItems: NavItem[] = [
  ...
  { href: "/leads",          label: "Clientes (CRM)",      icon: Users,           feature: "leads" },
  { href: "/chat",           label: "Chat",             icon: MessageSquare,   feature: "chat" },
  { href: "/calendario",     label: "Calendário",       icon: CalendarDays,    feature: "calendario" },
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl bg-primary/10 ring-1 ring-primary/25 flex items-center justify-center shrink-0 overflow-hidden p-1">
          <Image
            src="https://i.ibb.co/5W2qgpmH/BG-MINHA-LOGO-1.png"
            alt="Salomão AI"
            width={40}
            height={40}
            className="object-contain drop-shadow-[0_0_10px_rgba(132,204,22,0.25)]"
            unoptimized
          />
        </div>
        {!collapsed && (
          <div className="overflow-hidden">
            ...
            <p className="text-[10px] uppercase tracking-[0.18em] text-primary/80 font-bold">Plataforma</p>
          </div>
        )}
        <Button
          variant="ghost"
